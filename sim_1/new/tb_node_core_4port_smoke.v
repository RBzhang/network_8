...
module tb_node_core_4port_smoke;
    ...
    initial begin
        ...
        wait_for_outputs(4'b1110, 4'b0001, app_rx_count_seen);
        wait_outputs_quiet(20);

        inject_frame_1w(2, 8'd9, 8'd3, 16'd3, 32'h3333_0001);
        wait_for_outputs(4'b1011, 4'b0100, app_rx_count_seen);

        $display("PASS: tb_node_core_4port_smoke completed");
        $finish;
    end
endmodule
