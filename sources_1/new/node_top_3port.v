...
//------------------------------------------------------------------------------
// node_top_3port: 3-port board-level compatibility wrapper around node_core.
//------------------------------------------------------------------------------
module node_top_3port #(
    ...
    assign rx_clk_bus = {rx_clk2, rx_clk1, rx_clk0};
    assign tx_clk_bus = {tx_clk2, tx_clk1, tx_clk0};
    assign in_bus = {in2, in1, in0};
    assign valid_in_bus = {valid_in2, valid_in1, valid_in0};
