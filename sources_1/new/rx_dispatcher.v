            ...
            case (st)
                ...
                S_CLASSIFY: begin
                    if (active_src_id == my_id) begin
                        ...
                        local_should_deliver <= (active_dst_id == my_id) ||
                        ...
                        forward_should_forward <= (active_dst_id != my_id) || rx_is_broadcast[active_port];
                        forward_valid <= 1'b1;
                        st <= S_FWD_REQ;
                    end
                end
                ...
                S_FWD_WAIT: begin
                    if (forward_done) begin
                        if (forward_duplicate || !local_should_deliver) begin
                            frame_consumed[active_port] <= 1'b1;
                            st <= S_POLL;
                        end else begin
